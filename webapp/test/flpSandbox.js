		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sort Filter Table",
									"targetURL": "#comlichtermobilesortfilter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlichtermobilesortfilter-display": {
								"semanticObject": "comlichtermobilesortfilter",
								"action": "display",
								"description": "Template project für custom control Sort Filter Table",
								"title": "Sort Filter Table",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lichter.mobilesortfilter",
									"url": sap.ui.require.toUrl("com/lichter/mobilesortfilter")
								}
							}
						}
					}
